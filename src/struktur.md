...
│   ├── feature_engine.py         # [V3.2] Body-frame kinematic preprocessing + detector recovery provenance
│   │
│   │   # --- 2. CORE AI ENGINES ---
│   ├── faiss_manager.py          # [V3.2] FAISS descriptor DCT posisi+velocity, IP threshold
│   ├── lstm_manager.py           # [V3.2] Bi-Directional LSTM dengan masked attention
│   ├── transformer_manager.py    # [V3.2] Spatial-Temporal Transformer dengan padding mask
│   │
│   │   # --- 3. INFERENCE & UI LAYER ---
│   ├── inference_engine.py       # [V3.2] Worker-thread live inference, VAD 30-frame domain-matched + recovery
│   └── main_ui.py                # [V3.2] Dashboard Tkinter non-blocking
│
